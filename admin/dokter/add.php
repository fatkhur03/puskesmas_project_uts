...
if (isset($_POST["submit"])) {
    ...
    $data = [$_id, $_nama, $_gender, $_tmp_lahir, $_tgl_lahir, $_kategori, $_telpon, $_alamat, $_unit_kerja_id];
    $sql = "INSERT INTO pasien (id, nama, gender, tmp_lahir, tgl_lahir, kategori, telpon, alamat, unit_kerja_id) VALUES (?,? ,? ,? ,? ,? ,? ,?)";
                        ...
                        <div class="card-body">
                            ...
                            <form action="add.php" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        <input id="kategori" name="email" type="kategori" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
